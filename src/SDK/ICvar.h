...
public:
	...
	void RegisterConCommand(ConVar *base)
	{
		typedef void (* oRegisterConCommand)(void*, ConVar* );
		return getvfunc<oRegisterConCommand>(this, 10)(this, base);
	}

	void UnregisterConCommand(ConVar *base)
	{
		typedef void (* oUnregisterConCommand)(void*, ConVar* );
		return getvfunc<oUnregisterConCommand>(this, 11)(this, base);
	}

	ConVar* FindCommandBase(char const* name)
	{
		typedef ConVar* (* oFindCommandBase)( void*, const char* );
		return getvfunc<oFindCommandBase>(this, 14)(this, name);
	}
